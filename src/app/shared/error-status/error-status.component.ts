...
export class ErrorStatusComponent {
  ...
  errorStatusList: any[] = [
    ...
    { statusCode: 404, statusMsg: "Not Found", statusImg: "https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif",content:"The Resource you requested is not available" },
    { statusCode: 403, statusMsg: "Forbidden", statusImg: "https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif",content:"Contact Administrator for access." },
  ...
  constructor(private routerQuery:RouterQuery, private location: Location){}
